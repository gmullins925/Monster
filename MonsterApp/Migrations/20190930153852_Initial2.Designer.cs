...
namespace MonsterApp.Migrations
{
    ...
    [Migration("20190930153852_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonsterApp.Context.UserMonsterCollection", b =>
                {
                    b.Property<int>("UserMonsterCollectionId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("UserMonsterCollectionId");
            ...
            modelBuilder.Entity("MonsterApp.Context.UserMonsterCollection", b =>
                {
                    b.HasOne("MonsterApp.Context.Monster", "Monster")
                        .WithMany()
                        .HasForeignKey("MonsterId");

                    b.HasOne("MonsterApp.Context.User", "User")
                        .WithMany()
